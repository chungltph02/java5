...
<table class="table table-bordered"">
		...
		<tbody>
			<c:forEach items="${ data.content}" var="cate">
				<tr>
					...
					<td><a href="/SOF2021_Java5_1/admin/categories/edit/${ cate.id }"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<a href="/SOF2021_Java5_1/admin/categories/delete/${ cate.id }"
		...
		<ul class="pagination">
			<c:forEach var="i" begin="0" end="${ data.totalPages - 1 }">
				<li class="page-item"><a class="page-link"
					href="/SOF2021_Java5_1/admin/categories/index?page=${ i }"> ${ i + 1 }
				</a></li>
			</c:forEach>
		</ul>
	</div>
	<div>
		<a class="btn btn-success"
			href="/SOF2021_Java5_1/admin/categories/create">Them moi </a>
	</div>
